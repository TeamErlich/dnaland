...
public:
	...
	boost::dynamic_bitset<>& getMarkerBits() { return markers; }
	const boost::dynamic_bitset<>& getMarkerBits() const { return markers; }
...
int countDifferences(MarkerSet* a, MarkerSet* b);
